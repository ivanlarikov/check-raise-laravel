...
Route::middleware(['auth:sanctum', 'role:Room Manager'])->name('checkin.')
  ...
  ->group(function () {
    ...
    Route::post('update_id_check', [CheckinController::class, 'updateIdCheck']);
    ...
    Route::post('latearraival', [CheckinController::class, 'latearraival']);
    Route::post('updateexpiry', [CheckinController::class, 'updateexpiry']);
    Route::delete('latearrivalremove/{id}/{playerid}', [CheckinController::class, 'latearrivalremove']);
  });
